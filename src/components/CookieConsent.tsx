  ...
  return (
    <AnimatePresence>
      {showConsent && (
        ...
        >
          <div className="card bg-card border border-border shadow-lg rounded-xl w-[300px] md:w-[320px]">
            <svg version="1.1" id="cookieSvg" x="0px" y="0px" viewBox="0 0 122.88 122.25" className="w-12 h-12 mb-2" xmlSpace="preserve">
              <g>
            ...
            <p className="text-lg font-bold mb-1">We use cookies</p>
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="px-5 py-1.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 relative overflow-hidden group"
              >
              ...
              <button 
                ...
                className="px-5 py-1.5 bg-accent hover:bg-accent/90 text-accent-foreground rounded-full transition-all duration-300 hover:scale-105 hover:shadow-md active:scale-95"
              >
                Decline
              </button>
            </div>
